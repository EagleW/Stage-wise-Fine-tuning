...
logger = logging_t.get_logger(__name__)
...
class BartEncoder(nn.Module):
    ...
    def __init__(self, config: BartConfig, embed_tokens):
        ...
        role_max, tree_max = config.role_max, config.tree_max
        self.role_embed = nn.Embedding(role_max, embed_dim, padding_idx=1)
    ...
    def forward(
        ...
        x = inputs_embeds + embed_pos + embed_role + embed_tree
...
class BartForConditionalGeneration(PretrainedBartModel):
    ...
    def get_output_embeddings(self):
        return _make_linear_from_emb(self.model.shared)  # make it on the fly       return scores
    ...
    def generate(
        ...
        role_ids: Optional[torch.LongTensor]=None, tree_ids: Optional[torch.LongTensor]=None,
        ...
        **model_kwargs
        ...
        if self.config.is_encoder_decoder:
            ...
            encoder_outputs: ModelOutput = encoder(input_ids, attention_mask=attention_mask, role_ids=role_ids, tree_ids=tree_ids, return_dict=True)
